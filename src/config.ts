export const config = {
    developer: {
        ...
        description: "AI Engineer and Data Engineer building end-to-end intelligent systems. LLM orchestration, agentic pipelines, RAG, and production ML at scale. 3+ years of shipped systems with measurable impact."
    },
    social: {
    ...
    about: {
        title: "About Me",
        description: "AI Engineer and Data Engineer with 3+ years building and deploying end-to-end intelligent systems for concrete production problems including insurance claims automation, ad auction fraud detection, and research question answering. My expertise spans LLM orchestration, RAG pipelines, agentic systems, large-scale data engineering with Spark and Kafka, and production ML deployment. Every system I build is grounded in shipped code and measurable impact."
    },
    experiences: [
        {
            ...
            responsibilities: [
                "Built production claims decision systems with LLM evaluation and RAG pipelines, reducing downstream errors by 18%",
        ...
        },
        {
            ...
            location: "Tempe, AZ",
            description: "Built a research assistant system for academic question answering using Python, PyTorch, and RAG pipelines. Improved answer relevance by 34% across student queries.",
            responsibilities: [
        ...
        {
            position: "Data Engineer and AI Engineer, Uber Ads",
            company: "Uber Technologies (Via Nineleaps)",
            period: "Jul 2022 to Jul 2024",
            location: "Bangalore (New York Ad Operations)",
            description: "Built large-scale data pipelines and ML models for the Uber Ads platform. Engineered distributed data infrastructure processing 50M+ daily auction events for fraud detection, anomaly detection, and eCPM optimization across Uber Eats and Uber Mobility.",
            responsibilities: [
                "Designed and maintained scalable ETL pipelines using PySpark, SQL, and Kafka processing 50M+ daily auction events",
                "Built feature engineering pipelines and feature stores supporting fraud model training and real-time bidding decisions",
                "Deployed production fraud and bidding models with full observability, monitoring, and CI/CD on Jenkins and GitLab",
                "Engineered vector embeddings and data infrastructure for eCPM optimization at scale across Eats and Mobility",
                "Managed end-to-end inference pipelines, measuring auction quality impact and iterating on improvements continuously"
            ],
            technologies: ["Python", "PySpark", "TensorFlow", "XGBoost", "Kafka", "AWS Redshift", "Airflow", "SQL", "Spark"]
        },
        {
            ...
            description: "Built deep learning inference models for Galaxy S24 computational photography. Achieved real-time Exynos inference through quantization and pruning, shipped to millions of devices.",
            responsibilities: [
    ...
    projects: [
        {
            ...
            github: "https://github.com/data-geek-astronomy",
            description: "End-to-end agentic system for insurance claims decisioning combining Claude and GPT-4 orchestration with LangGraph. RAG retrieval grounds decisions in policy data with tool use, human-in-the-loop checkpoints, safety guardrails, and evaluation harnesses validated on 10K+ monthly claims."
        },
        {
            id: 2,
            ...
            description: "Production anomaly detection system monitoring advertiser bidding behavior in real time. Applied Isolation Forest and DBSCAN across 500M+ daily auctions surfacing a 34% eCPM variance driver and an 8x fraud signal invisible to rule-based systems. XGBoost model achieved AUC 0.94."
        },
        {
            id: 3,
            title: "Amazon Ad Auction Simulator",
            category: "Simulation / Data Engineering",
            technologies: "Python, GSP Auction Engine, CTR Modelling, Floor Pricing, Revenue Optimization, PySpark",
        ...
        },
        {
            ...
            description: "Comprehensive computer vision system combining 2D object detection (DETR, F1 score 0.89), semantic segmentation (DeepLabV3+, 19-class Cityscapes), depth estimation, and sensor fusion with self-supervised learning (MoCo) and domain adaptation (DANN)."
        },
        {
            id: 5,
            title: "Chem RAG",
        ...
        },
        {
            ...
            description: "System recognizing human emotions from both text and voice data using deep learning, NLP, and audio processing achieving 87% accuracy. Applications span human-computer interaction, mental health monitoring, and sentiment-aware interfaces."
        },
        {
            id: 7,
        ...
        },
        {
            ...
            description: "Real-time sentiment analysis engine that analyzes tweets about any event or topic to measure public sentiment polarity across positive, negative, and neutral signals. Built to track sentiment trends around breaking news, product launches, and social movements."
        },
        {
            id: 9,
            ...
            description: "Exploratory data analysis on Netflix Originals dataset uncovering insights on genres, runtimes, premiere dates, IMDb scores, and language distribution. Identifies content strategy patterns and viewership signals across the Netflix library."
        },
        {
            id: 10,
            title: "Airbnb EDA",
            ...
            description: "In-depth EDA on Airbnb listing data identifying pricing trends, location-based patterns, availability insights, and host behavior. Advanced visualizations surface actionable insights for hosts and travelers."
        },
        {
            id: 11,
        ...
        },
        {
            ...
            description: "Classic multi-class flower classification using the Iris dataset. Compares SVM, KNN, and Decision Tree classifiers with comprehensive evaluation metrics. A benchmark exploration of supervised learning fundamentals and model selection."
        }
    ],
    contact: {
        email: "aravind.kumar.nalukurthi@gmail.com",
    ...
    skills: {
        ...
        design: {
            ...
            description: "Production data pipelines and ML systems with measurable impact",
            details: "PySpark, Kafka, Airflow, SQL, AWS Redshift, Feature Stores, ETL Pipelines, TensorFlow, PyTorch, XGBoost, Scikit-learn, Isolation Forest, Docker, Kubernetes, MLflow.",
            tools: ["PySpark", "Kafka", "Airflow", "SQL", "AWS Redshift", "Feature Stores", "PyTorch", "XGBoost", "Docker", "MLflow"]
        }
    }
};
